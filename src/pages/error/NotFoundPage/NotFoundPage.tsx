      ...
      <div className="w-full max-w-lg mx-4 my-8 text-center">
        ...
        <div className="flex justify-center">
          <Button
            ...
            className="flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 text-white hover:from-orange-600 hover:via-pink-600 hover:to-purple-700 focus:ring-purple-500 shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 transition-all duration-300 transform hover:scale-105 px-5 py-2.5 text-base font-medium w-[200px] rounded-lg"
            leftIcon={
              <svg

      ...
      <div className="flex items-start justify-between mb-4 bg-[#172032] px-8 py-4.5 -mx-8 -mt-8 w-[calc(100%+4rem)]">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-70 pl-10 pr-4 py-1.5 bg-[#232b3d] border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          />
        </div>
      </div>
    </div>
